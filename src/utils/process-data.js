...
const COLUMN_MAPPINGS = {
  ...
  products: {
    inputColumns: ['STT', 'Mã TK', 'Tên gọi riêng', 'Dòng hàng', 'Đường kính vòng (mm)', 'Ni', 'Kích thước độ DÀY ĐÁY - Mặc định', 'Kích thước độ RỘNG ĐÁY - Mặc định2', 'Kích thước chiều CAO ổ/chấu', 'Status'],
